dados = 'C:/Users/rcosin/Desktop/FIA/TCC/online_shoppers_intention/online_shoppers_intention.csv'
delimitador = ','
target = 'Revenue'
separador_decimal = '.'
codigo_out = 'C:/Users/rcosin/Desktop/FIA/TCC/online_shoppers_intention/ML_online_shoppers_intention.py'
...
GradientBoostingClassifier;{'learning_rate':[1, 0.25, 0.05, 0.01], 'n_estimators':[4, 16, 100], 'max_depth':[2,8,16], 'min_samples_split':[0.1, 1.0, 10], 'min_samples_leaf':[0.1, 0.5, 5], 'max_features':[int(X_train.shape[1]*0.25), int(X_train.shape[1]*0.50), int(X_train.shape[1]*0.75), int(X_train.shape[1])] }
